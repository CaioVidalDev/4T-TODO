...
public class MesagemCadastroTest {
    ...
    @Test // Metodo Teste
    public void testMensagemCadastroTarefa() { // Teste para cadastro de tarefa
       ...
       caixaDeBusca.sendKeys("Teste De Cadastrar"); // Digita no campo

       WebElement salvarCadastro = driver.findElement(By.id("salvarCadastro")); // Encontra o botao de salvar
       salvarCadastro.click(); // Clica no botao

       /* Mensagem de Cadastrado com Sucesso */
       WebElement cadastroSucess = driver.findElement(By.id("mensagemCadastroSucess"));  // Encontra o campo de mensagem de cadastro
       String mensagemCadastroSucess = cadastroSucess.getText(); // Recebe o texto 
       
       if(mensagemCadastroSucess.contains("Tarefa cadastrada com sucesso!")) { // Se no texto contem "Tarefa cadastrada com sucesso!"
       System.out.println("Teste de Mensagem de cadastro de tarefa realizado com sucesso"); // Aparece essa mensagem
       }else{
